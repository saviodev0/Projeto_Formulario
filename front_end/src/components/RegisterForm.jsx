...
export default function RegisterForm() {
  ...
  // Estados locais para controlar a interface do formulário
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Limpa mensagem de sucesso automaticamente
        setTimeout(() => {
          setSuccessMessage('');
        }, 3000);
      }
      ...
      if (error.response) {
        ...
        // Requisição enviada, mas sem resposta do servidor
        setErrorMessage('Erro de conexão. Verifique se o servidor está rodando.');
      } else {
        // Qualquer outro erro local
